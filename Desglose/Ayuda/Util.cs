...
namespace Desglose.Ayuda
{
    public class Util
    {
        ...
        public static bool IsParallel(XYZ p, XYZ q, double tolera = 0.00005)
        {
        ...
        public static bool IsParallel_soloMuro(XYZ p, XYZ q)
        {
            //   return p.CrossProduct(q).IsZeroLength();    => menor IsZeroLength()<1.10-9
            var largo = p.CrossProduct(q).GetLength();
        ...
        public static XYZ ExtenderPuntoCOnRespeco2ptos(XYZ ptoOrigen, XYZ PtoFinal, double distaciaDesdePtoFina)
        {
            ...
            double angulo = angulo_entre_ptRadXY0(ptoOrigen, PtoFinal);
        ...
        public static ModelArc CrearCirculo_ModelLine(double d, XYZ centro, string graphic_stylesName, Document _doc)
        {
            ModelArc arc1 = null;
            try
            {
                using (Transaction t = new Transaction(_doc))
                {
                    ...
                    Element line_styles_Magenta = TiposLinea.ObtenerTipoLinea(graphic_stylesName, _doc);
        ...
        //vistas
        public static DetailArc CrearCirculo_DetailLine(double d, XYZ centro, UIDocument uidoc, string graphic_stylesName = "ROJO")
        {
                ...
                using (Transaction t = new Transaction(uidoc.Document))
                {
                 ...
                 //   Plane geomPlane = Plane.CreateByNormalAndOrigin(normal, origin); // 2017
                  ...
                  //  ModelArc arc1 = uidoc.Document.Create.NewModelCurve(geomArc1, sketch) as ModelArc;
                     ...
                     lineafalsa = uidoc.Document.Create.NewDetailCurve(uidoc.ActiveView, geomArc1) as DetailArc;


                    ////obtener linestyle 'ROJO'
                    //FilteredElementCollector graphic_styles = new FilteredElementCollector(uidoc.Document).OfClass(typeof(GraphicsStyle));
                    ////int n1 = graphic_styles.Count<Element>();
                    ////obtiene el line style con filter
                    //List<Element> red_line_styles = graphic_styles.Where<Element>(e => e.Name.ToString() == "ROJO").ToList();

                    Element red_line_styles = TiposLinea.ObtenerTipoLinea(graphic_stylesName, uidoc.Document);
        ...
        public static double angulo_entre_ptRadXY0(XYZ pt1, XYZ pt2)
        {
        ...
        public static ElementId GetPhaseId(string phaseName, Document doc)
        {
            ElementId id = null;
        ...
        public static WinForms.DialogResult InfoMsg_YesNoCancel(string msg)
        {
            Debug.WriteLine(msg);
        ...
        public static WinForms.DialogResult ErrorMsgConDesctivar(string msg)
        {
            Debug.WriteLine(msg);
    ...
    return e;
      ...
      return elementsByName.First<Element>();
        ...
        public class SpellingErrorCorrector
        {
            ...
            public Definition NewDefinition(Definitions definitions, string name, ParameterType parameterType)
            {
        ...
        public static void HelpLog(string texto, string ruta)
        {
            ...
            //  const string ruta = @"\\Server-cdv\usuarios2\jose.huerta\programas\elev.txt";
    ...
    public static class JtPlaneExtensionMethods
    {
        ...
        /// </summary>
        public static XYZ ProjectOntoXY(this Plane plane, XYZ p, XYZ Direccion)
        {
    ...
    public static class CompatibilityMethods
    {
        ...
        public static Definition Create2(this Definitions definitions, Document doc, string nome, ParameterType tipo, bool visibilidade)
        {
            ...
            if (ls.Count > 0)
            {
                ...
                object ed = c.Invoke(new object[] { nome, tipo }); ed.GetType().GetProperty("Visible").SetValue(ed, visibilidade, null);
