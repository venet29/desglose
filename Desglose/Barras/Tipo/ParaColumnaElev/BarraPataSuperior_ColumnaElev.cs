...
{
    public class BarraPataSuperior_ColumnaElev : ARebarLosa_desglose, IRebarLosa_Desglose
    {
        ...
        public BarraPataSuperior_ColumnaElev(UIApplication uiapp, RebarElevDTO _rebarInferiorDTO, IGeometriaTag newGeometriaTag) : base(_rebarInferiorDTO)
        {
