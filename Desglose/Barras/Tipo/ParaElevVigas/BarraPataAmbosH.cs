...
{
    public class BarraPataAmbosH : AARebarLosa_desgloseH, IRebarLosa_Desglose
    {
        ...
        public BarraPataAmbosH(UIApplication uiapp, RebarElevDTO _rebarInferiorDTO, IGeometriaTag newGeometriaTag) : base(_rebarInferiorDTO)
        {
