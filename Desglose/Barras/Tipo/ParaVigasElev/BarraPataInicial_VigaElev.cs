...
{
    public class BarraPataInicial_VigaElev : AARebarLosa_desglose_VigaElev, IRebarLosa_Desglose
    {
        ...
        public BarraPataInicial_VigaElev(UIApplication uiapp, RebarElevDTO _rebarInferiorDTO, IGeometriaTag newGeometriaTag) : base(_rebarInferiorDTO)
        {
