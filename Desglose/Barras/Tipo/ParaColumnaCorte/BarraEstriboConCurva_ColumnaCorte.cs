...
{
    public class BarraEstriboConCurva_ColumnaCorte : ARebarLosa_desglose, IRebarLosa_Desglose
    {
        ...
        public BarraEstriboConCurva_ColumnaCorte(UIApplication uiapp, RebarElevDTO _rebarInferiorDTO, IGeometriaTag newGeometriaTag) : base(_rebarInferiorDTO)
        {
            this.uiapp = uiapp;
